...
export declare abstract class AbstractRepository<TDocument extends AbstractDocument> {
    ...
    findPaginate(filterQuery: FilterQuery<TDocument>, page?: number, limit?: number): Promise<import("mongoose").PaginateResult<import("mongoose").IfAny<TDocument, any, import("mongoose").Document<unknown, {
        page: number;
        limit: number;
        sort: {
            timestamp: number;
