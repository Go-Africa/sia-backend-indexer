...
let HostRepository = HostRepository_1 = class HostRepository extends abstract_repository_1.AbstractRepository {
    constructor(hostModel, connection) {
        super(hostModel, connection);
        this.logger = new common_1.Logger(HostRepository_1.name);
    }
};
HostRepository = HostRepository_1 = __decorate([
...
//# sourceMappingURL=host.repositort.js.map