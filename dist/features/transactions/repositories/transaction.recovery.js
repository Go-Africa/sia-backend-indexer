...
const transaction_shema_1 = require("../schemas/transaction.shema");
let TransactionsRepository = TransactionsRepository_1 = class TransactionsRepository extends abstract_repository_1.AbstractRepository {
...
TransactionsRepository = TransactionsRepository_1 = __decorate([
    ...
    __param(0, (0, mongoose_1.InjectModel)(transaction_shema_1.Transaction.name)),
